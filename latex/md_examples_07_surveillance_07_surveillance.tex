\hypertarget{md_examples_07_surveillance_07_surveillance_autotoc_md9}{}\doxysection{Main features}\label{md_examples_07_surveillance_07_surveillance_autotoc_md9}
...
\hypertarget{md_examples_07_surveillance_07_surveillance_autotoc_md10}{}\doxysection{Algorithm}\label{md_examples_07_surveillance_07_surveillance_autotoc_md10}
Setup
...
\item Set statuses (arbitrary number of them).
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item Update status for susceptible/infected/removed(?)
\item Mutate virus(es) (each individual)
\item Run global actions (e.\+g., surveillance)
...
\end{DoxyItemize}\hypertarget{md_examples_07_surveillance_07_surveillance_autotoc_md11}{}\doxysection{Hello world (\+C++)}\label{md_examples_07_surveillance_07_surveillance_autotoc_md11}
...
\DoxyCodeLine{  epiworld::Virus<> covid19("{}covid 19"{});}
\DoxyCodeLine{  covid19.set\_infectiousness(.8);}
\DoxyCodeLine{  }
\DoxyCodeLine{  // Creating a tool}
\DoxyCodeLine{  epiworld::Tool<> vax("{}vaccine"{});}
...
\DoxyCodeLine{  model.add\_virus(covid19, .01);}
\DoxyCodeLine{  model.add\_tool(vax, .5);}
\DoxyCodeLine{}
...
\end{DoxyCode}
\hypertarget{md_examples_07_surveillance_07_surveillance_autotoc_md12}{}\doxysection{Surveillance simulation}\label{md_examples_07_surveillance_07_surveillance_autotoc_md12}
...
\end{DoxyItemize}\hypertarget{md_examples_07_surveillance_07_surveillance_autotoc_md13}{}\doxysubsection{Preliminary results}\label{md_examples_07_surveillance_07_surveillance_autotoc_md13}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{ggplot(hist\_comb, aes(x = date, y = counts + 1, colour = status, linetype=sim)) +}
...
\hypertarget{md_examples_07_surveillance_07_surveillance_autotoc_md14}{}\doxysubsection{Cases detected}\label{md_examples_07_surveillance_07_surveillance_autotoc_md14}
