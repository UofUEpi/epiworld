...
Various examples can be found in the \mbox{[}examples\mbox{]}(examples) folder.\hypertarget{index_autotoc_md1}{}\doxysection{Hello world}\label{index_autotoc_md1}
...
Which took about 0.\+134 seconds ($\sim$ 7.\+5 million ppl x day / second).\hypertarget{index_autotoc_md2}{}\doxysubsection{Tools}\label{index_autotoc_md2}
