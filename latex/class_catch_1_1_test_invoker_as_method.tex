...
\begin{center}
\leavevmode
\includegraphics[width=246pt]{class_catch_1_1_test_invoker_as_method__inherit__graph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=246pt]{class_catch_1_1_test_invoker_as_method__coll__graph}
\end{center}
\end{figure}
